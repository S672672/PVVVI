...
export default function Cards({picture,isAvailable}) {
  return (
    <div className='h-96 w-96 m-2 bg-white border-solid border-4 rounded-lg z-10 flex-col justify-center items-center cursor-pointer p-1 shadow-black shadow-md transform hover:scale-105 transition-transform duration-200'>
